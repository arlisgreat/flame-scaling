...
OUTPUT_ROOT="${1:-${ROOT}/artifacts/runs/tongue017_frame182_heldout_scale_caps4000}"
...
names=(
  hard_cap003 hard_cap006 hard_cap012 hard_cap030
  r050_cap003 r050_cap006 r050_cap012 r050_cap030
  free_cap003 free_cap006 free_cap012 free_cap030
)
radii=(0 0 0 0 50 50 50 50 -1 -1 -1 -1)
caps=(3 6 12 30 3 6 12 30 3 6 12 30)
...
echo "Completed held-out scale-cap ablation: ${OUTPUT_ROOT}"
